...
function graduate_get_default_theme_options() {
	$graduate_default_options = array(
		...
		// About Content
		'about_content_enable'				=> 'disabled',
		'about_content_type'				=> 'page',

		// Trending Courses
		'trending_courses_enable'			=> 'disabled',
		...
		// Top Destination
		'top_destination_enable'			=> 'disabled',
		...
		// Client Section
		'client_section_enable'				=> 'disabled',
		'client_section_content_type'		=> 'page',
		'client_section_count'				=> 6,

		// News & Event
		'news_events_enable'				=> 'disabled',
